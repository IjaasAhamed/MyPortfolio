  ...
  <div className='projects-container mx-5'>
    ...
    <div className='project col-lg-6 col-sm-12 mb-4'>
      ...
      <div className='skillsec col-lg-12 col-sm-12' id="skillsec">
        ...
        <img src={skillImg} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>Html</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg1} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>CSS</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg2} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>JavaScript</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg3} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>Php</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg4} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>React JS</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg5} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>Node JS</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg6} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>Bootstrap</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg7} alt='Ijaas Ahamed' className='skillImg'/>
        <h5 className='pt-2 fs-6'>Java</h5>
        </div>
        <div className='text-center txtclr col-lg-3 col-sm-3 p-4 hov'>
        <img src={skillImg8} alt='Ijaas Ahamed' className='skillImg'/>
